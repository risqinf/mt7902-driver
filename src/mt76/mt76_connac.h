...
{
	/*
	 * The MT7921 hardware reports chip id 0x7961. The MT7902 is a Connac2
	 * device in the same family and shares the MT7921 code path, so both
	 * chip ids are matched here.
	 */
